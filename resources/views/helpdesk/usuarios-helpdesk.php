        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- SECCION DE CHAT F2F -->
                    <div class="col-lg-6 border border-primary p-0" style="height: 450px;overflow-y: scroll;">
                        <section class="chat ">
                            ...
                            <div id="messageschat" class="messages-chat mb-5" style="height: 420px;overflow-y: scroll;">
