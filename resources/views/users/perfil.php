                            ...
                            <div class="card">
                                <div class="card-header p-2">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item w-25"><a class="nav-link rounded-0 border border-primary active" href="#settings" data-toggle="tab">Settings</a></li>
                                        <li class="nav-item w-25"><a class="nav-link rounded-0 border border-primary" href="#activity" data-toggle="tab">Activity</a></li>
                                        <li class="nav-item w-25"><a class="nav-link rounded-0 border border-primary " href="#timeline" data-toggle="tab">Timeline</a></li>
                                    </ul>
                                </div><!-- /.card-header -->
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class=" tab-pane" id="timeline">
                                            ...
                                            <div class="timeline timeline-inverse">
                                                ...
                                                <!-- timeline item -->
                                                <div>
                                                    <i class="fas fa-envelope bg-primary text-white"></i>
                                                ...
                                                <!-- timeline item -->
                                                <div>
                                                    <i class="fas fa-user bg-info text-white"></i>
                                                ...
                                                <!-- timeline item -->
                                                <div>
                                                    <i class="fas fa-camera bg-purple text-white"></i>
                                                ...
                                                <!-- END timeline item -->
                                                <div>
                                                    <i class="far fa-clock bg-gray text-white"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.tab-pane -->
