                        ...
                        <table class="table table-hover ">
                            ...
                            <tbody id="mostrarTrabajador">
                                <tr ng-repeat="usuario in usuariosLists.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage))">
                                    ...
                                    <td>
                                        <button ng-click="usuarioPermisos(usuario.id)" class="btn bg-info text-white btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalPerms">Permisos</button>
                                    </td>
    ...
    <div class="modal fade" id="exampleModalPerms" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-lg-12">
                        <label><input type="checkbox" name="permisos[]" id="cbox1" value="1" ng-checked="1==permisos[0].id_permiso"> Dashboard</label>
                    </div>
                    <div class="col-lg-12">
                        <label><input type="checkbox" name="permisos[]" id="cbox2" value="2" ng-checked="2==permisos[1].id_permiso"> Pedidos</label>
                    </div>
                    <div class="col-lg-12">
                        <label><input type="checkbox" name="permisos[]" id="cbox3" value="3" ng-checked="3==permisos[2].id_permiso"> Clientes</label>
                    </div>
                    <div class="col-lg-12">
